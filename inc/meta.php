...
$images_path = THEME_ASSETS_DIR_URI . '/img/';
...
<?php } else { ?>
<link rel="icon" type="image/x-icon" href="<?= $icons_path . 'favicon.png' ?>">
<?php } ?>
<?php if ($favicon_png_32) { ?>
<link rel="icon" type="image/png" href="<?= $favicon_png_32['url'] ?>">
<?php } else { ?>
<link rel="icon" type="image/png" href="<?=  $icons_path . 'favicon32.png' ?>" sizes="32x32">
<?php } ?>
<?php if ($favicon_png_192) { ?>
<link rel="icon" type="image/png" href="<?= $favicon_png_192['url'] ?>">
<?php } else { ?>
<link rel="icon" type="image/png" href="<?=  $icons_path . 'favicon192.png' ?>" sizes="192x192">
<?php } ?>
...
<meta property="og:image" content="<?= $images_path . $main_ogg_name .'?ver=2.0' ?>">
