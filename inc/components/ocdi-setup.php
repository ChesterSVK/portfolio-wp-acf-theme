...
function glitche_ocdi_import_files() {
	return array(
		array(
			...
			'local_import_file'			=> trailingslashit( get_template_directory() ) . 'demo/e01/content.xml',
			...
			'preview_url'				  => 'https://glitche.bslthemes.com/ve1/',
		),
		array(
			'import_file_name'			 => 'One Page (Elementor)',
			'categories'				   => array( 'Elementor' ),
			'local_import_file'			=> trailingslashit( get_template_directory() ) . 'demo/e02/content.xml',
			...
			'preview_url'				  => 'https://glitche.bslthemes.com/ve2/',
		),
		array(
			'import_file_name'			 => 'Creative (Elementor)',
			'categories'				   => array( 'Elementor' ),
			'local_import_file'			=> trailingslashit( get_template_directory() ) . 'demo/e03/content.xml',
			//'local_import_widget_file'	 => trailingslashit( get_template_directory() ) . 'demo/02/widgets2.json',
			//'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'demo/02/customizer2.dat',
			'import_preview_image_url'	 => get_template_directory_uri() . '/demo/e03/preview.jpg',
			'preview_url'				  => 'https://glitche.bslthemes.com/ve3/',
		),
		array(
			'import_file_name'			 => 'Dark Skin (Elementor)',
			'categories'				   => array( 'Elementor' ),
			'local_import_file'			=> trailingslashit( get_template_directory() ) . 'demo/e04/content.xml',
			//'local_import_widget_file'	 => trailingslashit( get_template_directory() ) . 'demo/02/widgets2.json',
			//'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'demo/02/customizer2.dat',
			'import_preview_image_url'	 => get_template_directory_uri() . '/demo/e04/preview.jpg',
			'preview_url'				  => 'https://glitche.bslthemes.com/ve4/',
		),
		...
		array(
			...
			'preview_url'				  => 'https://glitche.bslthemes.com/v1/',
		),
		array(
			...
			'preview_url'				  => 'https://glitche.bslthemes.com/v2/',
		),
		array(
			...
			'preview_url'				  => 'https://glitche.bslthemes.com/v3/',
		),
		array(
			...
			'preview_url'				  => 'https://glitche.bslthemes.com/v4/',
		),
	);
}
